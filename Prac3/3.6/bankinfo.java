...
public class bankinfo {
   ...
   static final String DB_URL = "jdbc:postgresql://127.0.0.1:5432/s2b140053131020";

   //  Database credentials
   static final String USER = "postgres";
   static final String PASS = "sudhir7";
 ...
 Double ph,acno;
  ...
  try{
      ...
      System.out.println(" \n Connecting to a  s2b140053131020 database");
	   ...
	   Scanner sc=new Scanner(System.in);
            while(i!=1){
                ...
                switch(ch){
                    ...
                    case 2:
                        stmt=con.prepareStatement("update Bank set balance=? where account_no= ?");  
                        System.out.print("Enter Account No:");
                        acno=sc.nextDouble();
                        System.out.print("Enter balance:");
                        bal=sc.nextDouble();
                        ...
                        break;
                    case 3:
                        stmt=con.prepareStatement("delete from Bank where account_no=?");
                        System.out.print("Enter Account No:");
                        acno=sc.nextDouble();
                        stmt.setDouble(1,acno);
                        stmt.executeUpdate();
					...
					case 4:
						  ...
						  String sql = "select * from bank where balance > "+Amount+"";
							  ...
							  ResultSet rs = stmt1.executeQuery(sql);
									...
									while(rs.next())
									{
										acno=rs.getDouble("account_no");
										name=rs.getString("name");
										bal=rs.getDouble("balance");
										ph=rs.getDouble("phone_no");
